...
class VatNumberXlsx(models.AbstractModel):
    _name = "report.l10n_es_vat_book_igic.l10n_es_vat_book_igic_xlsx"
    ...
    #     line = self.env.ref("l10n_es_vat_book_igic.aeat_vat_book_map_line_p_iva_nd")
    #     return book.get_taxes_from_templates(line.tax_tmpl_ids)

    def _get_vat_book_map_lines(self, book_type):
        return self.env["atc.vat.book.igic.map.line"].search(
            [
    ...
    def create_issued_sheet(self, workbook, book, draft_export):
        ...
        sheet.merge_range("N6:N7", "Tipo de IGIC", header_format)
        sheet.merge_range("O6:O7", "Cuota IGIC Repercutida", header_format)
        last_col = "O"
    ...
    def create_received_sheet(self, workbook, book, draft_export):
        ...
        sheet.merge_range("O6:O7", "Tipo de IGIC", header_format)
        sheet.merge_range("P6:P7", "Cuota IGIC Soportado", header_format)
